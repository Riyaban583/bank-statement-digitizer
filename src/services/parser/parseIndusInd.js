/**
 * parseIndusInd.js
 * Parser for IndusInd Bank account statements.
 *
 * IndusInd digital statement column layout:
 *   Date | Narration | Cheque No. | Debit | Credit | Balance
 *
 * Standard 6-column layout. Debit and Credit are explicit.
 * Balance is the last column.
 */
 ...
 */
export function parseIndusInd(fullText) {
