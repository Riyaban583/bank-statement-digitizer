/**
 * parsePNB.js
 * Parser for Punjab National Bank account statements.
 *
 * PNB digital statement column layout:
 *   Date | Narration | Chq. No. | Debit | Credit | Balance
 *
 * Balance may have "Dr" suffix indicating an overdraft account.
 * Debit and Credit columns are explicit.
 */
 ...
 */
export function parsePNB(fullText) {
