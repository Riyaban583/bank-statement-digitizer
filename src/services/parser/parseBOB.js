/**
 * parseBOB.js
 * Parser for Bank of Baroda account statements.
 *
 * BOB digital statement column layout:
 *   Tran Date | Tran Particulars | Instrument No | Debit | Credit | Balance
 *
 * Debit and Credit are explicit columns.
 * The balance column sometimes carries a "Cr" or "Dr" suffix — stripped before parsing.
 */
 ...
 */
export function parseBOB(fullText) {
