/**
 * parseAU.js
 * Parser for AU Small Finance Bank account statements.
 *
 * AU Small Finance Bank digital statement column layout:
 *   Date | Transaction Details | Ref No. | Debit | Credit | Balance
 *
 * Standard 6-column layout similar to Axis/Kotak.
 ...
 */
export function parseAU(fullText) {
