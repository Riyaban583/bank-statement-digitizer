 ...
 *
 * Kotak digital statement column layout:
 *   Date | Description | Chq / Ref number | Debit | Credit | Balance
 *
 * Debit and Credit columns are explicit. Balance is the last column.
 * Amounts use Indian number formatting (e.g. 1,00,000.00).
 */
 ...
 */
export function parseKotak(fullText) {
